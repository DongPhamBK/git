...
### Những dòng này được định nghĩa sao cho đối diện "up" sẽ là L0 ###
# Tạo 16 dòng để có thể "nhìn" xung quanh , tức là tầm nhìn
VISION_16 = (
#   L0            L1             L2             L3
...
# Tạo 8 dòng để có thể "nhìn" xung quanh
# Thực sự ta chỉ cần dùng VISION_16 mà không có dòng số lẻ
VISION_8 = tuple([VISION_16[i] for i in range(len(VISION_16)) if i%2==0])

# Tạo 4 dòng để có thể "nhìn" xung quanh
# Thực sự ta chỉ cần dùng VISION_16 nhưng xóa mọi thứ không chia hết cho 4 là xong
